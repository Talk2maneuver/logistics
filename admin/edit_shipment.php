        ...
        <?php if ($shipment): ?>
            <div class="table-container">
                ...
                <form method="POST" style="display: grid; gap: 1.5rem; padding: 1.5rem;">
                        ...
                        <div id="items-container" style="display: grid; gap: 1rem;">
                            ...
                            <?php else: ?>
                                ...
                                <div class="item-row" style="display: grid; grid-template-columns: 2fr 1fr auto; gap: 1rem; align-items: start;">
                                    <div class="form-group">
                                        <label>Description</label>
                                        <input type="text" name="items[0][description]" placeholder="Item description" value="<?= htmlspecialchars($shipment->description ?? '') ?>" style="width: 100%; padding: 0.75rem; background: rgba(15, 23, 42, 0.6); border: 1px solid var(--border-color); border-radius: 8px; color: white;">
                                    </div>
                                    <div class="form-group">
                                        <label>Weight (kg) *</label>
                    ...
                    <!-- Price Configuration -->
                    <div>
                        <h3 style="margin-bottom: 1rem; color: var(--text-primary);">Price Configuration</h3>
